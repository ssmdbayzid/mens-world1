...
const Header = ({isTopOfPage, setTopOfPage}) => {
  ...
  <div className="flex items-center md:order-2">
   ...
   {/* Above Medium Menu  */}
    ...
    onCLinkck={()=>setMenuToggle(!isMenuToggle)}
    type="button" className="inLinkne-flex items-center md:hidden p-2 ml-1 text-sm text-gray-500 rounded-l hover:bg-gray-100 focus:outLinkne-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600" aria-controls="mobile-menu-2" aria-expanded="false">
      ...
      <svg className="w-6 h-6" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M3 5a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zM3 10a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zM3 15a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1z" cLinkp-rule="evenodd"></path></svg>
  </button> :  <button data-collapse-toggle="mobile-menu-2" 
    onCLinkck={()=>setMenuToggle(!isMenuToggle)}
    type="button" className="inLinkne-flex items-center md:hidden p-2 ml-1 text-sm text-gray-500 rounded-l hover:bg-gray-100 focus:outLinkne-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600" aria-controls="mobile-menu-2" aria-expanded="false">
      <span className="sr-only">Open main menu</span>
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6">
  <path fill-rule="evenodd" d="M5.47 5.47a.75.75 0 011.06 0L12 10.94l5.47-5.47a.75.75 0 111.06 1.06L13.06 12l5.47 5.47a.75.75 0 11-1.06 1.06L12 13.06l-5.47 5.47a.75.75 0 01-1.06-1.06L10.94 12 5.47 6.53a.75.75 0 010-1.06z" cLinkp-rule="evenodd" />
</svg>
  </button> )
