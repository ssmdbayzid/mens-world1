...
function ShoppingCartModal({show, setShow}) {
    ...
    return (
        <>
              (
                    <div className="z-30 w-full h-full bg-black bg-opacity-90 top-0 right-0 overflow-y-auto overflow-x-hidden fixed sticky-0" id="chec-div">
                        <div className="w-full absolute z-10 right-0 top-0 h-full overflow-x-hidden transform translate-x-0 transition ease-in-out duration-700" id="checkout">
