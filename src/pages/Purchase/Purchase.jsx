  ...
  <div className="container  py-24 mx-auto w-5/6">
    <div className="lg:w-4/5 w-full mx-auto flex flex-wrap ">
      ...
      <div className="lg:w-1/2 mx-auto w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
        ...
        <p className="leading-relaxed flex font-bold">In Stock &nbsp;  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="green" className="w-6 h-6 text-bold">
